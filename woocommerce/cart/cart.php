	...
	<table class="shop_table shop_table_responsive cart woocommerce-cart-form__contents" cellspacing="0">
		<thead>
			<tr>
				...
				<th class="product-thumbnail"><?php esc_html_e( 'Item', 'woocommerce' ); ?></th>
...
echo apply_filters( 'woocommerce_cart_item_price', WC()->cart->get_product_price( $_product ), $cart_item, $cart_item_key ); // PHPCS: XSS ok.
        ...
        $discount_total += $discount;
							echo '<p class="re-price"><del>'.$regular_price.' ر.س</del></p>';
						echo '<p class="s-price">'.$sale_price.' ر.س</p>';
						echo '<p class="saved-price"><span>You saved </span>'.$discount_total.' ر.س</p>';
        }
					else{
					echo apply_filters( 'woocommerce_cart_item_price', WC()->cart->get_product_price( $_product ), $cart_item, $cart_item_key ); // PHPCS: XSS ok.	
					}
