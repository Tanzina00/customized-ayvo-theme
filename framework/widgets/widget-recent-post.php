...
if ( !class_exists( 'Recent_Blog_Widget' ) ) {
	class Recent_Blog_Widget extends WP_Widget
	{
		function __construct()
		{
			...
			parent::__construct( 'widget_ovic_post', 'Ovic: Recent Post', $widget_ops );
		}
                        ...
                        <article <?php post_class( 'post-item' ); ?>>
                            <div class="post-thumb">
                                <a href="<?php the_permalink(); ?>">
									<?php
									$image_thumb = apply_filters( 'ovic_resize_image', get_post_thumbnail_id(), 70, 65, true, true );
		...
		function form( $instance )
		{
			...
			$choose_post_field = array(
				...
				'title'      => esc_html__( 'Choose Type Post', 'ayvo' ),
			);
			...
			$ids_field = array(
				...
				'title'      => esc_html__( 'Search by name Post', 'ayvo' ),
			);
			...
			$category_field = array(
				...
				'title'      => esc_html__( 'Category', 'ayvo' ),
			);
			...
			$number_field = array(
				...
				'dependency' => array( 'choose_post', '==', '0' ),
				'title'      => esc_html__( 'Number Post', 'ayvo' ),
			);
